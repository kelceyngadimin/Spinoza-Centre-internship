...
template='/home/kngadimin/software/dnfitting/submissions/template_2folds.sh'
...
myyaml='/home/kngadimin/software/dnfitting/submissions/examp_yaml.yml'
# point this to where you want the jobscripts output
out_dir='/home/kngadimin/JOBS/'
...
mysuppdicts=[dict({'---subject---':str(p),'---data_portion---':str(dp), '---session---':str(ses)}) for p in ['001', '002', '003', '004', '005'] for dp in range(20) for ses in [2,3]] #357
